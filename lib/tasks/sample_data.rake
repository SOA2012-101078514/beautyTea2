namespace :db do
  ...
  task populate: :environment do
    ...
    admin.toggle!(:admin)
    us = User.create!(name: "Yo Yo", phone:"333", phone_confirmation:"333", mode:"admin", pass_course:false)
    us.toggle!(:admin)
    us = User.create!(name: "Wei Wei", phone:"0977", phone_confirmation:"0977", mode:"normal", pass_course:false)
